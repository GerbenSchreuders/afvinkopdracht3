...
d_count = sequentie.count('ctgag')
b_count = sequentie.count('tccgga')
e_count = sequentie.count('gaattc')
h_count = sequentie.count('aagctt')
t_count = sequentie.count('tcga')

#print(d_count, b_count, e_count, h_count, t_count)



if d_count > 0:
    print("DdeI knipt het eiwit")

else:
    print("DdeI knipt niet")
    
if b_count > 0:
    print("BspMII Knipt het eiwit")
    
else:
    print("BspMII knipt niet")

if e_count > 0:
    print("EcoRI knipt het eiwit")
    
else:
    print("EcoRI knipt niet")

if h_count > 0:
    print("HindIII knipt het eiwit")
    
else:
    print("HindIII knipt niet")

if t_count > 0:
    print("TaqI knipt het eiwit")
